...
//! [`RedisCachePermissions::in_channel`] and
//! [`RedisCachePermissions::root`] operations you must enable
...
//! [`RedisCachePermissions::check_member_communication_disabled`].
//!
...
pub struct RedisCachePermissions<'a> {
    cache: &'a RedisCache,
    check_member_communication_disabled: bool,
}

impl<'a> RedisCachePermissions<'a> {
    ...
    /// reference.
    pub const fn into_cache(self) -> &'a RedisCache {
        self.cache
    }
...
mod tests {
    use super::{
        ChannelError, ChannelErrorType, RedisCachePermissions, RootError, RootErrorType,
    };
    ...
    assert_impl_all!(RedisCachePermissions<'_>: Clone, Debug, Send, Sync);
    ...
    ///
    /// [`root`]: super::RedisCachePermissions::root
    #[test]
    fn root_errors() {
        let cache = RedisCache::new();
    ...
    ///
    /// [`in_channel`]: super::RedisCachePermissions::in_channel
    #[test]
